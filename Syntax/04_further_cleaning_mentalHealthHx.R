...
# TODO: Waiting on revised script from Jianhui
...
table(mentalHealthHx_itt$disorders)
table(mentalHealthHx_itt$other_Desc)

sum(grepl("PTSD", mentalHealthHx_itt$disorders)) # Typo in codebook
sum(grepl("PSTD", mentalHealthHx_itt$disorders)) # Search for "PSTD" instead

sum(grepl("subst", mentalHealthHx_itt$disorders)) # Not sure why Jianhui has 0

sum(grepl("other", mentalHealthHx_itt$disorders)) # Typo in codebook
sum(grepl("Other", mentalHealthHx_itt$disorders)) # Search for "Other" instead
...
table(mentalHealthHx_itt$pastDisorders)
table(mentalHealthHx_itt$other_DescNo)

sum(grepl("PTSD", mentalHealthHx_itt$pastDisorders)) # Typo in codebook
sum(grepl("PSTD", mentalHealthHx_itt$pastDisorders)) # Search for "PSTD" instead

sum(grepl("subst", mentalHealthHx_itt$pastDisorders)) # Not sure why Jianhui has 0

sum(grepl("other", mentalHealthHx_itt$pastDisorders)) # Typo in codebook
sum(grepl("Other", mentalHealthHx_itt$pastDisorders)) # Search for "Other" instead
...
table(mentalHealthHx_itt$help)
table(mentalHealthHx_itt$other_HelpCurrent)

sum(grepl("school_counselor", mentalHealthHx_itt$help)) # Not sure why Jianhui has 0

sum(grepl("religious_leader", mentalHealthHx_itt$help)) # Not sure why Jianhui has 0

sum(grepl("support_group", mentalHealthHx_itt$help)) # Not sure why Jianhui has 0
...
table(mentalHealthHx_itt$pastHelp)
table(mentalHealthHx_itt$other_HelpPast)

sum(grepl("school_counselor", mentalHealthHx_itt$pastHelp)) # Not sure why Jianhui has 0

sum(grepl("religious_leader", mentalHealthHx_itt$pastHelp)) # Not sure why Jianhui has 0

sum(grepl("support_group", mentalHealthHx_itt$pastHelp)) # Not sure why Jianhui has 0
